...
RUN apt update
RUN DEBIAN_FRONTEND=noninteractive apt -y install python3-full python3-pip git keyutils cifs-utils ca-certificates python3-dev libkrb5-dev krb5-user libcap2-bin git wget sudo
...
RUN apt update
RUN DEBIAN_FRONTEND=noninteractive apt -y install vault
